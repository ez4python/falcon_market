...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to Falcon",

    # Copyright on the footer
    "copyright": "Falcon Online Shopping Ltd",
    ...
    "topmenu_links": [
        ...
        {"name": "Support", "url": "https://github.com/akbarali-hah", "new_window": True},
...
AWS_STORAGE_BUCKET_NAME = os.getenv('MINIO_BUCKET_NAME')  # MINIO_BUCKET_NAME
